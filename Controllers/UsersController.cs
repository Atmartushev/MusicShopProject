...
namespace MusicShopProject.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(MusicShopProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UsersID,UserName,Password,UserType")] Users users)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UsersID,UserName,Password,UserType")] Users users)
        {
            if (id != users.UsersID)
            {
                return NotFound();
